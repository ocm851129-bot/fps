const CACHE = 'triad-mobile-v1';
const ASSETS = ['./index.html','./style.css','./mobile.css','./game.js','./touch.js','./pwa.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'];
